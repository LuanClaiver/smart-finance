(() => {
  ...
  function enhanceAuth() {
    ...
    if (!hero.querySelector('.runtime-auth-badge')) {
      ...
      badge.innerHTML = '<img src="/icon.svg" alt=""><span>Smart Finance <b>0.4.4</b></span>'
      hero.prepend(badge)
    }
    ...
    if (!card.querySelector('.runtime-auth-brand')) {
      ...
      brand.innerHTML = '<div class="runtime-auth-brand-copy"><img src="/icon.svg" alt="Logo Smart Finance"><div><strong>Smart Finance</strong><small>Versão 0.4.4</small></div></div>'
