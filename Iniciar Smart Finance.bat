...
set "READY=%SF_HOME%\ambiente-pronto-0.4.3.txt"
...
:prepare
echo ================================================
echo       PREPARANDO SMART FINANCE 0.4.3
echo ================================================
...
>"%READY%" echo Smart Finance 0.4.3 preparado em %date% %time%
echo.
