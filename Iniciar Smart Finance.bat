...
set "READY=%SF_HOME%\ambiente-pronto-0.4.1.txt"
...
:prepare
echo ================================================
echo       PREPARANDO SMART FINANCE 0.4.1
echo ================================================
...
>"%READY%" echo Smart Finance 0.4.1 preparado em %date% %time%
echo.
